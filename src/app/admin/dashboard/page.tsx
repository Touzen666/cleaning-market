          ...
          <div className="rounded-lg border-4 border-dashed border-gray-200 p-8">
            <div className="text-center">
              ...
              <p className="mb-8 text-lg text-gray-600">
                Zarządzanie systemem i funkcjonalnościami dostępnymi tylko dla
        ...
        <div className="grid grid-cols-1 gap-6 px-4 sm:px-0 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="overflow-hidden rounded-lg bg-white shadow">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <button
                  onClick={() => router.push("/admin/dashboard/api")}
            ...
            <div className="px-6 py-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <button
                  ...
                  className="inline-flex items-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700"
                >
                  <svg
                    className="mr-2 h-4 w-4"
                    fill="none"
